...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737147462
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/influenceR/libs/influenceR.so
/V4/usr/lib64/R/library/influenceR/libs/influenceR.so
